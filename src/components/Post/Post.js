...
export default class Post extends Component {
  ...
  render() {
      ...
      <section className="Post__parent" onClick={ this.hideMasterMenu }>
        ...
        <div className="Post__master-controls">
          ...
          <div className="Post__master-menu" style={ { display: showMasterMenu ? 'flex' : 'none' } }>
            ...
            <span onClick={() => this.props.deletePostFn(this.props.post.id)} >Delete</span>
          </div>
        </div>
    ...
    <span className="Post__date">{this.props.post.date}</span>
        </div>
        ...
        <div className="Post__content">
          {
            ...
            editing
            ?
              <Edit text={this.props.post.text}
                    id={this.props.post.id}
                    updatePostFn={this.props.updatePostFn}
                    hideEdit={ this.hideEdit } />
            :
          <span className="Post__text">{this.props.post.text}</span>
          }
        </div>
